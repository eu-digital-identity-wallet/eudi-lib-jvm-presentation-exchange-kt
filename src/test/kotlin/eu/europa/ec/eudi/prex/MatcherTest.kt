...
private fun printResult(
    ...
    fun InputDescriptorEvaluation.str() =
        when (this) {
            is InputDescriptorEvaluation.NotMatchingClaim -> {
                "Not matched"
            }

            is InputDescriptorEvaluation.CandidateClaim -> {
                "Matched\n\t\t\t" +
                    matches.entries
